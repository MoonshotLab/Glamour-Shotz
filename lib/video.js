...
var directives = {
  ...
  'final' : {
    ...
    command     : function(inputFile, outputDir){
      ...
      var watermarkPosition = 'overlay=main_w-overlay_w-30:main_h-overlay_h-30';
      if(inputFile.indexOf('.gif') != -1){
        watermark = 'watermark-small.png';
        watermarkPosition = 'overlay=main_w-overlay_w:main_h-overlay_h-15';
      }
      ...
      return [
        ...
        inputFile,
        '-i',
        path.join(process.cwd(), watermark),
        '-filter_complex "' + watermarkPosition + '"',
        '-pix_fmt yuv420p',
        path.join(outputDir, this.out),
        '-y'
      ].join(' ');
